Function Fix-CitrixVDA {
    <#
    .SYNOPSIS
    Function to change DDC's (if required) and restart Citrix Desktops Services
    by Steven Wight
    .DESCRIPTION
    Fix-CitrixVDA -ComputerName <Hostname> -DDC <DDCServerNames> (Default = DDC001V &002V) -Domain <domain> (default = POSHYT)
    .EXAMPLE
    ...
    Param( 
        ...
        [string] [ValidateNotNullOrEmpty()] $DDC = "DDC001V.POSHYT.corp DDC002V.POSHYT.corp", 
        [string] [ValidateNotNullOrEmpty()] $Domain = "POSHYT"
    )
...
function Check-CitrixWorkspaceandVDAVersion {
    <#
    .SYNOPSIS
    Function to Check Citrix Workspace and VDA version
    by Steven Wight
    .DESCRIPTION
    Check-CitrixWorkspaceandVDAVersion -ComputerName <Hostname> -Domain <Domain> default = 'POSHYT'
    .EXAMPLE
...
Function Get-CitrixEventLogs{
    ...
    Param(
        ...
        ValueFromPipelineByPropertyName = $true)]
        [String] [ValidateNotNullOrEmpty()] $ComputerName, 
        [String] [ValidateNotNullOrEmpty()] $Days = 30, 
        [String] [ValidateNotNullOrEmpty()] $Domain = "POSHYT" 
    )
